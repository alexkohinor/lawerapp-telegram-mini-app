/**
 * Скрипт для тестирования Data Persistence Layer с SQLite
 */
...
async function testConsultationManager() {
  ...
  try {
    // Создаем тестового пользователя для этого теста
...
async function main() {
  console.log('🚀 Запуск тестирования Data Persistence Layer с SQLite\n');
