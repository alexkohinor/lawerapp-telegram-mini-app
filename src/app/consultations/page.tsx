        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <HapticFeedback type="medium">
            <Button
              ...
              className="px-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              Новая консультация
            </Button>
          </HapticFeedback>
                ...
                {filter === 'all' && (
                  <HapticFeedback type="medium">
                    <Button
                      variant="default"
                      onClick={handleNewConsultation}
                      className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
